...
const mk: typeof en = {
  ...
  availability: {
    ...
    reservedCellTitle: "Кликнете за да ја управувате резервацијата",
    deleteReservationTitle: "Да се избрише резервацијата?",
    deleteReservationBody: "Ова трајно ќе ја отстрани резервацијата. Ова не може да се врати.",
    deleteButton: "Избриши резервација",
    returnDayTitle: "Возилото се враќа денес — кликнете за нова резервација",
    legendReturnDay: "Враќање денес",
