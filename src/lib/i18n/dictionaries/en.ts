const en = {
  ...
  contracts: {
    ...
    client: {
      ...
      licenceSection: "Driving licence",
      licenceNumber: "ID",
      licenceIssueDate: "Issue date",
  ...
  availability: {
    ...
    reservedCellTitle: "Click to manage this reservation",
    deleteReservationTitle: "Delete reservation?",
    deleteReservationBody: "This will permanently remove the reservation. This cannot be undone.",
    deleteButton: "Delete reservation",
    returnDayTitle: "Car returns today — click to start a new reservation",
    legendReturnDay: "Returns today",
  ...
  admin: {
    ...
    createForm: {
      ...
      ownerPasswordConfirm: "Confirm owner password *",
      address: "Address",
      email: "Email",
      phone: "Phone number",
