...
const sq: typeof en = {
  ...
  availability: {
    ...
    reservedCellTitle: "Kliko për ta menaxhuar këtë rezervim",
    deleteReservationTitle: "Të fshihet rezervimi?",
    deleteReservationBody: "Kjo do ta heqë përgjithmonë rezervimin. Kjo veprim nuk mund të zhbëhet.",
    deleteButton: "Fshi rezervimin",
    returnDayTitle: "Makina kthehet sot — kliko për rezervim të ri",
    legendReturnDay: "Kthim sot",
